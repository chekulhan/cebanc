...
# Seed - si ejecutas varias veces, que occure
np.random.seed(42)

numbers = np.random.randint(1, 101, 5)
numbers = np.random.randint(1, 101, size=[2,5])
...
```
nota_max = input("Cual es la nota para filtrar")
print(f"Nota MAX es {nota_max}")
np.random.default_rng()

notas = np.random.randint(1, 101, size=[10])

print("Todas las notas")
print(notas)

# filtrar con la nota MAX del usuario
notas_max_array = notas[notas >= nota_max]
print(notas_max_array)
