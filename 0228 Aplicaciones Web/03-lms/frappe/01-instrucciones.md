...
**Step 1:** Clone the repo como frappe-lms

```
$ git clone https://github.com/frappe/lms.git frappe-lms
...
Suele tardar varios minutos en configurar todo. PACIENCIA: En otro terminal, ejecutar: docker compose logs -f
...
Usar docker logs para ver errores:
